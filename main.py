...
def get_items_urls(file_path):
    ...
    with open("newparser\\items_urls2", "w", encoding="utf-8") as file:
        for url in urls:
            file.write(f"{url}\n")
...
def get_data(file_path):
    ...
    with open("newparser\\result.json", "w", encoding="utf-8") as file:
...
def main():
    ...
    # print(get_items_urls(file_path="C:\\Users\\Valera\\Desktop\\newparser\\source-page.html"))
    print(get_data(file_path="newparser\\items_urls2.txt"))
